...
class ExcursionFieldMap
{
    ...
    private const array BASIC_VALIDATION_RULES = [
        ...
        'stoxoi' => ['array', 'nullable'],
        'stoxoi.*' => ['string'],
        'dianyktereush' => ['string', 'nullable'],
        'aa_programmatos' => ['string', 'nullable'],
    ];
    ...
    {
        return [
            'Ο εμπλουτισμός της εκπαιδευτικής εμπειρίας και του προγράμματος σπουδών μέσω της παρατήρησης, της διερεύνησης και της συμμετοχής',
            'Η γνωριμία με τους θεσμούς της δημοκρατίας, η ανάπτυξη δημοκρατικού ήθους και η εμπέδωση των αξιών των δικαιωμάτων του ανθρώπου',
            ...
            'H επαφή με το φυσικό περιβάλλον, η ευαισθητοποίηση σε θέματα αειφορίας και βιωσιμότητας και η ενίσχυση της σωματικής και ψυχικής υγείας και ευεξίας',
            ...
            'Η βελτίωση των ικανοτήτων στις ξένες γλώσσες, η ενίσχυση της διαπολιτισμικής εκπαίδευσης και οι αλληλεπιδράσεις με μαθητές/τριες από διαφορετικά κράτη και πολιτισμικά περιβάλλοντα',
            'Η ανάπτυξη των κοινωνικών και επικοινωνιακών δεξιοτήτων',
            'Η υποστήριξη της ολοκληρωμένης γνωστικής, κοινωνικής και ψυχολογικής ανάπτυξης μέσω της σταδιακής αυτονόμησης, της ανάληψης υποχρεώσεων και ευθυνών, της καλλιέργειας της ενσυναίσθησης και του σεβασμού των άλλων',
