    ...
    public function getExcursionTypes(): array
    {
        return [
            'Σχολικός Περίπατος' => [
                ...
                'min_files' => 1,
                'legislation' => 'Άρθρο 4 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Διδακτική επίσκεψη' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 1,
                'legislation' => 'Άρθρο 5 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Εκπαιδευτική επίσκεψη μέσω προγράμματος(περιβαλλοντικό/πολιτισμικό) στο εσωτερικό' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 1,
                'legislation' => 'Άρθρο 6 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Εκπαιδευτική εκδρομή στο εσωτερικό' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 2,
                'legislation' => 'Άρθρο 7 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Ημερήσια δίχως διανυκτέρευση' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 1,
                'legislation' => 'Άρθρο 8 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Συμμετοχή μαθητών/τριών σε διαγωνισμούς/εκδηλώσεις εσωτερικού' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 1,
                'legislation' => 'Άρθρο 9 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
            ...
            'Μετακίνηση μαθητών-τριών και εκπαιδευτικών με πρόγραμμα ERASMUS+ΚΑ2' => [
                ...
                'school_types' => ['ΓΥΜΝΑΣΙΟ', 'ΛΥΚΕΙΟ', 'ΕΠΑΛ', 'ΕΚ'],
                'min_files' => 5,
                'legislation' => 'Άρθρο 12 της Υ.Α. 109113/ΓΔ4/19-8-2026, (ΦΕΚ 5237/τ.Β\'/19-08-2026)',
