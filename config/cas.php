...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'sso.sch.gr'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'sso.sch.gr'),
    ...
    */
    'cas_cert' => env('CAS_CERT', '/usr/share/ca-certificates/sch/sch_root_cert.pem'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'https://sso.sch.gr/logout'),
