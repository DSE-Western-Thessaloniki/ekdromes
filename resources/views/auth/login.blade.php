...
<body class="font-sans bg-gradient-to-b from-white to-coral min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full p-8">
        <div class="bg-white rounded-xl shadow-lg p-10 text-center">
            <img src="{{ Vite::asset('resources/images/icons8-bus-64.png') }}" alt="Logo" class="w-32 mx-auto mb-5">
            ...
            <form action="{{ route('login.post') }}" method="POST">
                @csrf
                <button type="submit"
                    class="w-full bg-coral text-white px-10 py-3 text-lg rounded hover:bg-coral-dark transition-colors">
