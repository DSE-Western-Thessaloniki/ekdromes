    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <form action="{{ route('excursion.upload-file', $excursion) }}" method="POST"
                                ...
                                @foreach ($files as $file)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-2 border">
                                            @if ($file['type'] === 'F')
                                                <span
                                                    class="inline-block bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full">Τελικό</span>
                                            @elseif($file['type'] === 'A')
                                                <span
                                                    class="inline-block bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Αναμένει
                                                    έγκριση</span>
                                            @else
                                                <span
