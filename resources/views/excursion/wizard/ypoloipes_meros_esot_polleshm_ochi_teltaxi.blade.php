...
@section('content')
    ...
    <div class="flex flex-col items-center gap-4 pb-4">
        ...
        <a class='btn btn-primary'
            value='Εκπαιδευτική επίσκεψη μέσω προγράμματος(περιβαλλοντικό/πολιτισμικό) στο εσωτερικό'>Εκπαιδευτική επίσκεψη
            μέσω προγράμματος(περιβαλλοντικό/πολιτισμικό κτλ) στο εσωτερικό</a>
        <a class='btn btn-primary' value='Εκπαιδευτική εκδρομή στο εσωτερικό'>Εκπαιδευτική
            εκδρομή στο εσωτερικό(στο πλαίσιο του αναλυτικού προγράμματος)</a>
        <a class='btn btn-primary' value='Επίσκεψη στη Βουλή των Ελλήνων'>Επίσκεψη στη
            Βουλή των Ελλήνων</a>
