...
@section('content')
    ...
    <p class="center">Παρακαλούμε να εγκρίνετε την παρακάτω πολυήμερη εκπαιδευτική εκδρομής των μαθητών του σχολείου μας, στο
        εξωτερικό</p>
    ...
    <p class="lh-1.5 page-break">
        <b>Γ. ΣΤΟΙΧΕΙΑ ΕΚΔΡΟΜΗΣ</b> (Η μετακίνηση πραγματοποιείται στο πλαίσιο της Υ.Α 20883/ΓΔ4/12-02-2020, ΦΕΚ
        456/τ.Β/13-02-2020) άρθρο 2 &sect; 5.<br> <br>
    ...
    <p class="lh-1.5 justify">
        ...
        1. Αντίγραφο της πράξης του συλλόγου διδασκόντων για τη μετακίνηση (στην
        οποία αναγράφονται, εκτός των άλλων, το αναλυτικό πρόγραμμα της
        μετακίνησης, ολογράφως τα ονοματεπώνυμα των εκπαιδευτικών)<br> <br>
