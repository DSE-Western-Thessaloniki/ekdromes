...
@section('content')
    ...
    <p>
    <p class="title justify">ΘΕΜΑ: Έγκριση μετακίνησης μαθητών/τριών και εκπαιδευτικών
        με προορισμό: <i>{{ $excursion->proorismos }}</i> με εγκεκριμένο πρόγραμμα
        σχολικών δραστηριοτήτων του άρθρου 3&sect;1</p>
    ...
    <p class="indent justify">
        ...
        @endif
        με εγκεκριμένο <i>{{ $excursion->eidos_programmatos }}</i> πρόγραμμα σχολικών
        δραστηριοτήτων με τίτλο «<i>{{ $excursion->titlos_programmatos }}</i>».
    </p>
